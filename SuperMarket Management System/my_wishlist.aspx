<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="my_wishlist.aspx.cs" Inherits="SuperMarket_Management_System.shopping_wishlist" %>
...
<%--<input class="prompt srch10" type="text" placeholder="Search for products..">--%>
    <asp:TextBox ID="TextBox1" class="prompt srch10" placeholder="Search for products.." runat="server"></asp:TextBox>
...
<a href="my_wishlist.aspx" class="user-item active"><i class="uil uil-heart"></i>Shopping Wishlist</a>
...
<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span class="__cf_email__" data-cfemail="234a4d454c6344424e414c50565346514e42514846570d404c4e">[email&#160;protected]</span></a></li>
</ul>
</div>
<div class="col-md-6 col-sm-6">
...
<!-- Mirrored from Gambo.net/html-items/gambo_supermarket_demo/dashboard_my_wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jun 2021 09:08:18 GMT -->
</html>
