<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactus.aspx.cs" Inherits="SuperMarket_Management_System.contactus" %>
...
<asp:TextBox ID="TextBox4" TextMode="MultiLine" class="form-control" rows="3" placeholder="Write Message" runat="server"></asp:TextBox>
</div>    
</div>
<asp:Button ID="Button1" class="next-btn16 hover-btn mt-3" runat="server" data-btntext-sending="Sending..." Text="Submit Request" OnClick="contact_click" />
<br />
