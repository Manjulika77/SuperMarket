<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="request_product.aspx.cs" Inherits="SuperMarket_Management_System.request_product" %>
...
<%--<input class="prompt srch10" type="text" placeholder="Search for products..">--%>
           <asp:TextBox ID="TextBox2" class="prompt srch10" placeholder="Search for products.." runat="server"></asp:TextBox>
...
<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span class="__cf_email__" data-cfemail="94fdfaf2fbd4f3f5f9f6fbe7e1e4f1e6f9f5e6fff1e0baf7fbf9">[email&#160;protected]</span></a></li>
</ul>
</div>
<div class="col-md-6 col-sm-6">
...
<!-- Mirrored from Gambo.net/html-items/gambo_supermarket_demo/request_product.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jun 2021 09:08:29 GMT -->
</html>