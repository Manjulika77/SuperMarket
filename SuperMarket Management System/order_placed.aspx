<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_placed.aspx.cs" Inherits="SuperMarket_Management_System.WebForm1" %>
...
<li>
<a href="faq.aspx" class="offer-link"><i class="uil uil-question-circle"></i>Help</a>
</li>
<li>
...
<h2>Order Successfully Placed</h2> at <span><asp:Label ID="Label5" runat="server" Text=""></asp:Label></span>
...
<li><p><i class="uil uil-map-marker-alt"></i>Address :<span><asp:Label ID="Label1" runat="server" Text=""></asp:Label></span></p></li>
<li><p><i class="uil uil-phone-alt"></i>Phone Number :<span><asp:Label ID="Label2" runat="server" Text=""></asp:Label></span></p></li>
<li><p><i class="uil uil-envelope"></i>Email Address :<span><asp:Label ID="Label3" runat="server" Text=""></asp:Label></span></p></li>
...
<a href="shop_grid.aspx" class="invc-link hover-btn">Shop More</a>
</div>
<div class="placed-bottom-dt">
The payment of <span>$<asp:Label ID="Label4" runat="server" Text="">16</asp:Label></span> you'll make when the deliver arrives with your order.
</div>
</div>
</div>
</div>
...
<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span class="__cf_email__" data-cfemail="620b0c040d2205030f000d11171207100f03100907164c010d0f">[email&#160;protected]</span></a></li>
</ul>
</div>
<div class="col-md-6 col-sm-6">
