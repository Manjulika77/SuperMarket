<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="my_rewards.aspx.cs" Inherits="SuperMarket_Management_System.my_rewards" %>
...
<a href="forgotpassword.html" class="item channel_item page__links">Forgot Password</a>
<a href="contactus.html" class="item channel_item page__links">Contact Us</a>
</div>
</div>
</li>
<%--<li class="nav-item">
...
<a href="my_rewards.aspx" class="user-item active"><i class="uil uil-gift"></i>My Rewards</a>
...
<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span class="__cf_email__" data-cfemail="4920272f26092e28242b263a3c392c3b24283b222c3d672a2624">[email&#160;protected]</span></a></li>
</ul>
</div>
<div class="col-md-6 col-sm-6">
...
<%--<input id="email" name="email" type="text" placeholder="Email Address" class="form-control input-md" required="">--%>
 <asp:TextBox ID="TextBox2" name="email" placeholder="Email Address" class="form-control input-md" required="" runat="server"></asp:TextBox>
...
<!-- Mirrored from Gambo.net/html-items/gambo_supermarket_demo/dashboard_my_rewards.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jun 2021 09:09:12 GMT -->
</html>
