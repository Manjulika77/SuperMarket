<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard_overview.aspx.cs" Inherits="SuperMarket_Management_System.dashboard_overview" %>
...
<a href="faq.aspx" class="item channel_item"><i class="uil uil-info-circle icon__1"></i>Faq</a>
...
<a href="dashboard_overview.aspx" class="user-item active"><i class="uil uil-apps"></i>Overview</a>
...
<h2>Hi! &nbsp<asp:Label ID="Label3" runat="server" Text=""></asp:Label></h2>
</div>
</div>
...
<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span class="__cf_email__" data-cfemail="92fbfcf4fdd2f5f3fff0fde1e7e2f7e0fff3e0f9f7e6bcf1fdff">[email&#160;protected]</span></a></li>
</ul>
</div>
<div class="col-md-6 col-sm-6">
