<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="my_address.aspx.cs" Inherits="SuperMarket_Management_System.my_address" %>
...
<%--<input id="flat" name="flat" type="text" placeholder="Address" class="form-control input-md" required=""/>--%>
    <asp:TextBox ID="TextBox1" placeholder="Address" class="form-control input-md" required="" runat="server"></asp:TextBox>
</div>
</div>
<div class="col-lg-12 col-md-12">
<div class="form-group">
...
<%--<button class="save-btn14 hover-btn">Save</button>--%>
        <asp:Button ID="Button1" class="save-btn14 hover-btn" runat="server" Text="Save" />
</div>
</div>
</div>
</div>
...
<a href="my_wallet.aspx" class="user-item"><i class="uil uil-wallet"></i>My Wallet</a>
<a href="my_wishlist.aspx" class="user-item"><i class="uil uil-heart"></i>Shopping Wishlist</a>
<a href="my_address.aspx" class="user-item active"><i class="uil uil-location-point"></i>My Address</a>
...
<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span class="__cf_email__" data-cfemail="4f262129200f282e222d203c3a3f2a3d222e3d242a3b612c2022">[email&#160;protected]</span></a></li>
</ul>
</div>
<div class="col-md-6 col-sm-6">
...
<%--<input id="email" name="email" type="text" placeholder="Email Address" class="form-control input-md" required="">--%>
    <asp:TextBox ID="TextBox3" name="email" placeholder="Email Address" class="form-control input-md" required="" runat="server"></asp:TextBox>
...
<!-- Mirrored from Gambo.net/html-items/gambo_supermarket_demo/dashboard_my_addresses.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jun 2021 09:08:23 GMT -->
</html>
